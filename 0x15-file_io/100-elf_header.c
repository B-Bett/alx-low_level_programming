 ...
 * @e_ident: A pointer to an array which contain ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
 ...
 * @e_ident: A pointer to an array which contain the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: pointer to array contain the ELF.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_ident: A pointer to an array which contain the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - Displays the info contained in the ELF header at start
 * @argc: The number of arguments supplied to the program.
 * @argv: An array of pointers to the arguments.
 * Return: 0 (success)
 * Description: If the file isnt an ELF File,the func fails (exit code 98)
 */
